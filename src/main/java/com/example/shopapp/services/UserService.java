...
public class UserService implements IUserService {
  ...
  public String login(String email, String password) {
    ...
    if (!existingUser.isActive()) {
      ...
      resetViolation(existingUser.getId());
    }
  ...
  private void resetViolation(Long userId) {
  ...
  public void verifyEmail(String email) {
    ...
    MailBody mailBody =
        MailBody.builder()
            .to(email)
            .text(
                "Thank you for requesting to reset your account password."
                    + "\n"
                    + "\nYour OTP code is "
                    + otp
                    + ". \n"
                    ...
                    + "\n"
                    + "Note: This OTP code is only for you and must not be shared with anyone"
                    + " else.\n"
                    + "\n"
                    + "Best regards,\n"
